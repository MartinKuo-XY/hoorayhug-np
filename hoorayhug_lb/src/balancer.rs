...
impl Balancer {
    ...
    /// Report a successful connection to the downstream for health tracking.
    ...
    /// Report a failed connection to the downstream for health tracking.
    ...
    pub fn parse_from_str(s: &str) -> Self {
        ...
        Self::new(strategy, &weights, None)
    }
}
